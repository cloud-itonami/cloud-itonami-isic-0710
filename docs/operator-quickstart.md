# Operator Quickstart — Iron Ore Mining Operations Coordinator

Shortest path from clone to a verified local dry-run for **ISIC 0710** (`cloud-itonami-isic-0710`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0710.git
cd cloud-itonami-isic-0710
```
...
- Blueprint governor key: `iron-ore-governor`
- Likely source path: `ironops.governor.cljc`
